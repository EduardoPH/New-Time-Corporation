            ...
            <BoxStyled>
              ...
              <div className="box-denuncia">
                <div className="cabecalho">
                  <img
                    src="/assets/images/denuncias-recentes/Perfil.png"
                    alt=""
                  />
              ...
              <div className="lista-apoio">
                <div className="item-frase">
                  <p1>
                    ...
                    Invada. Caia. Seja tudo o quiser ser, mas acima de tudo,
                    seja você sempre.
                  </p1>
              ...
              <table className="tabela-usuaria">
                ...
                <tbody>
                  <tr>
                    ...
                    <td>11 94154654</td>
                    <td className="previa">
                      ato verbal ou escrito pelo qual alguém leva ao
                      conhecimento da autoridade competente um fato contrário à
                      lei, à ordem pública ou a algum regulamento e suscetível
                      de punição.
                    </td>
                    <td className="coluna-acao">
