    ...
    <Pag>
      <div className="pt1">
        <div className="pack-user">
          <img
            className="img-user"
            src="/assets/images/denuncia-detalhe/Perfil.png"
            alt=""
          />
      ...
      <div className="pt2">
        <div className="box-msg">
          ...
          <div className="cx-mensagem">
            <div className="msg-denuncia">
              {" "}
              declaração da testemunha ou da parte sobre determinado fato, do
              qual tem conhecimento ou que se relacione com seus interesses e
              que figura no processo como prova testemunhal.{" "}
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="container-caracter">
        <Carousel>
          ...
          <div className="box-detalhes">
            <div className="title-details-caracters">
              {" "}
              Características Físicas{" "}
            </div>
            <div className="box-detalhe">
              aqui será escrito informações complementares, ex: tatuagem,
              cicatriz, etc...
            </div>
          </div>
        </Carousel>
